...
pub struct SendNotifyTextMessageInput {
...
impl SendNotifyTextMessageInput {
    /// <p>The unique identifier of the notify configuration to use for sending the message. This can be either the NotifyConfigurationId or NotifyConfigurationArn.</p>
...
impl SendNotifyTextMessageInput {
    /// Creates a new builder-style object to manufacture [`SendNotifyTextMessageInput`](crate::operation::send_notify_text_message::SendNotifyTextMessageInput).
    pub fn builder() -> crate::operation::send_notify_text_message::builders::SendNotifyTextMessageInputBuilder {
        crate::operation::send_notify_text_message::builders::SendNotifyTextMessageInputBuilder::default()
    }
}

/// A builder for [`SendNotifyTextMessageInput`](crate::operation::send_notify_text_message::SendNotifyTextMessageInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SendNotifyTextMessageInputBuilder {
...
impl SendNotifyTextMessageInputBuilder {
    /// <p>The unique identifier of the notify configuration to use for sending the message. This can be either the NotifyConfigurationId or NotifyConfigurationArn.</p>
    ...
    /// Consumes the builder and constructs a [`SendNotifyTextMessageInput`](crate::operation::send_notify_text_message::SendNotifyTextMessageInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::send_notify_text_message::SendNotifyTextMessageInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::send_notify_text_message::SendNotifyTextMessageInput {
