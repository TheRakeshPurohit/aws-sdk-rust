...
pub struct ListImagesFilter {
    ...
    /// <p>The image status with which to filter your <code>ListImages</code> results. Valid values are <code>ACTIVE</code>, <code>ARCHIVED</code>, and <code>ACTIVATING</code>. If not specified, only images with <code>ACTIVE</code> status are returned.</p>
