...
pub use crate::operation::create_renewal::_create_renewal_input::CreateRenewalInputBuilder;

pub use crate::operation::create_renewal::_create_renewal_output::CreateRenewalOutputBuilder;

impl crate::operation::create_renewal::builders::CreateRenewalInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.create_renewal();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `CreateRenewal`.
///
/// <p>Creates a renewal contract for the specified Outpost.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct CreateRenewalFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::create_renewal::builders::CreateRenewalInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_renewal::CreateRenewalOutput,
        crate::operation::create_renewal::CreateRenewalError,
    > for CreateRenewalFluentBuilder
{
    fn send(
        self,
...
impl CreateRenewalFluentBuilder {
    /// Creates a new `CreateRenewalFluentBuilder`.
    ...
    /// Access the CreateRenewal as a reference.
    pub fn as_input(&self) -> &crate::operation::create_renewal::builders::CreateRenewalInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_renewal::CreateRenewal::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_renewal::CreateRenewal::orchestrate(&runtime_plugins, input).await
    }
