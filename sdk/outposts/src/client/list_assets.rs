...
impl super::Client {
    ...
    ///   - [`asset_type_filter(AssetType)`](crate::operation::list_assets::builders::ListAssetsFluentBuilder::asset_type_filter) / [`set_asset_type_filter(Option<Vec::<AssetType>>)`](crate::operation::list_assets::builders::ListAssetsFluentBuilder::set_asset_type_filter):<br>required: **false**<br><p>Filters the results by asset type.</p> <ul>  <li>   <p>COMPUTE - Server asset used for customer compute</p></li>  <li>   <p>STORAGE - Server asset used by storage services</p></li>  <li>   <p>POWERSHELF - Powershelf assets</p></li>  <li>   <p>SWITCH - Switch assets</p></li>  <li>   <p>NETWORKING - Asset managed by Amazon Web Services for networking purposes</p></li> </ul><br>
