...
impl super::Client {
    ...
    ///   - [`global_settings(impl Into<String>, impl Into<String>)`](crate::operation::update_global_settings::builders::UpdateGlobalSettingsFluentBuilder::global_settings) / [`set_global_settings(Option<HashMap::<String, String>>)`](crate::operation::update_global_settings::builders::UpdateGlobalSettingsFluentBuilder::set_global_settings):<br>required: **false**<br><p>Inputs can include:</p> <p>A value for <code>isCrossAccountBackupEnabled</code>. Values can be true or false. Example: <code>update-global-settings --global-settings isCrossAccountBackupEnabled=false</code>.</p> <p>A value for Multi-party approval, styled as <code>isMpaEnabled</code>. Values can be true or false. Example: <code>update-global-settings --global-settings isMpaEnabled=false</code>.</p> <p>A value for Backup Service-Linked Role creation, styled as <code>isDelegatedAdministratorEnabled</code>. Values can be true or false. Example: <code>update-global-settings --global-settings isDelegatedAdministratorEnabled=false</code>.</p><br>
