...
impl ListFindingsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `findings_summaries`. Queries to the underlying service
...
impl ListFindingsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_findings_output_output_findings_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
