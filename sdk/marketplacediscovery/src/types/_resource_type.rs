...
/// match resourcetype {
///     ResourceType::ManufacturerInstructions => { /* ... */ },
///     ResourceType::ManufacturerSupport => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceType {
    fn from(s: &str) -> Self {
        match s {
            "MANUFACTURER_INSTRUCTIONS" => ResourceType::ManufacturerInstructions,
            "MANUFACTURER_SUPPORT" => ResourceType::ManufacturerSupport,
...
impl ResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceType::ManufacturerInstructions => "MANUFACTURER_INSTRUCTIONS",
            ResourceType::ManufacturerSupport => "MANUFACTURER_SUPPORT",
            ResourceType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["MANUFACTURER_INSTRUCTIONS", "MANUFACTURER_SUPPORT"]
    }
}
...
impl ::std::fmt::Display for ResourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ResourceType::ManufacturerInstructions => write!(f, "MANUFACTURER_INSTRUCTIONS"),
            ResourceType::ManufacturerSupport => write!(f, "MANUFACTURER_SUPPORT"),
