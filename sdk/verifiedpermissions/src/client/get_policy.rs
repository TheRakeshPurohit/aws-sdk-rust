...
impl super::Client {
    ...
    ///   - [`name(Option<String>)`](crate::operation::get_policy::GetPolicyOutput::name): <p>The name of the policy, if one was assigned when the policy was created or last updated.</p>
