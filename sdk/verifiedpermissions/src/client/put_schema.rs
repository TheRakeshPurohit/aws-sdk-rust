...
impl super::Client {
    ...
    ///   - [`policy_store_id(impl Into<String>)`](crate::operation::put_schema::builders::PutSchemaFluentBuilder::policy_store_id) / [`set_policy_store_id(Option<String>)`](crate::operation::put_schema::builders::PutSchemaFluentBuilder::set_policy_store_id):<br>required: **true**<br><p>Specifies the ID of the policy store in which to place the schema.</p> <p>To specify a policy store, use its ID or alias name. When using an alias name, prefix it with <code>policy-store-alias/</code>. For example:</p> <ul>  <li>   <p>ID: <code>PSEXAMPLEabcdefg111111</code></p></li>  <li>   <p>Alias name: <code>policy-store-alias/example-policy-store</code></p></li> </ul> <p>To view aliases, use <a href="https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_ListPolicyStoreAliases.html">ListPolicyStoreAliases</a>.</p><br>
