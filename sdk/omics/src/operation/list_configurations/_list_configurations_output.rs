...
pub struct ListConfigurationsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::ConfigurationListItem>>,
...
impl ListConfigurationsOutput {
    ...
    pub fn items(&self) -> &[crate::types::ConfigurationListItem] {
...
pub struct ListConfigurationsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::ConfigurationListItem>>,
...
impl ListConfigurationsOutputBuilder {
    ...
    ///
    /// <p>List of configuration items.</p>
    pub fn items(mut self, input: crate::types::ConfigurationListItem) -> Self {
    ...
    /// <p>List of configuration items.</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ConfigurationListItem>>) -> Self {
        self.items = input;
        self
    }
    /// <p>List of configuration items.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ConfigurationListItem>> {
        &self.items
    }
    /// <p>Token for retrieving next page of results.</p>
