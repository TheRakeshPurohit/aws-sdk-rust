...
impl super::Client {
    ...
    ///   - [`batch_id(impl Into<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::batch_id) / [`set_batch_id(Option<String>)`](crate::operation::list_runs::builders::ListRunsFluentBuilder::set_batch_id):<br>required: **false**<br><p>Filter by batch ID.</p><br>
