...
pub fn ser_update_data_automation_project_input_input(
    ...
    if let Some(var_3) = &input.data_automation_library_configuration {
        #[allow(unused_mut)]
        let mut object_4 = object.key("dataAutomationLibraryConfiguration").start_object();
        crate::protocol_serde::shape_data_automation_library_configuration::ser_data_automation_library_configuration(&mut object_4, var_3)?;
        object_4.finish();
    }
    if let Some(var_5) = &input.encryption_configuration {
        #[allow(unused_mut)]
        let mut object_6 = object.key("encryptionConfiguration").start_object();
        crate::protocol_serde::shape_encryption_configuration::ser_encryption_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    if let Some(var_7) = &input.override_configuration {
        #[allow(unused_mut)]
        let mut object_8 = object.key("overrideConfiguration").start_object();
        crate::protocol_serde::shape_override_configuration::ser_override_configuration(&mut object_8, var_7)?;
        object_8.finish();
    }
    if let Some(var_9) = &input.project_description {
        object.key("projectDescription").string(var_9.as_str());
    }
