...
impl super::Client {
    ...
    ///   - [`session_name(impl Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::session_name) / [`set_session_name(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_session_name):<br>required: **false**<br><p>The session name for IAM role sessions.</p><br>
