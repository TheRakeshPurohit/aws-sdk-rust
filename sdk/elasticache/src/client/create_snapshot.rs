...
impl super::Client {
    ...
    ///   - [`snapshot_name(impl Into<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::snapshot_name) / [`set_snapshot_name(Option<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::set_snapshot_name):<br>required: **true**<br><p>A name for the snapshot being created. This value is stored as a lowercase string.</p><br>
