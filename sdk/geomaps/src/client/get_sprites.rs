...
impl super::Client {
    ...
    ///   - [`color_scheme(ColorScheme)`](crate::operation::get_sprites::builders::GetSpritesFluentBuilder::color_scheme) / [`set_color_scheme(Option<ColorScheme>)`](crate::operation::get_sprites::builders::GetSpritesFluentBuilder::set_color_scheme):<br>required: **true**<br><p>Sets the color tone for the map sprites, such as dark and light.</p> <p>Example: <code>Light</code></p> <p>Default value: <code>Light</code></p><note>  <p>Valid values for ColorScheme are case sensitive.</p> </note><br>
