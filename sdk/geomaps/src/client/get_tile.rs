...
impl super::Client {
    ...
    ///   - [`x(impl Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::x) / [`set_x(Option<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_x):<br>required: **true**<br><p>The X axis value for the map tile.</p><br>
