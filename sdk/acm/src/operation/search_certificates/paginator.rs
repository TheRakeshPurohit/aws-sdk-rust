...
/// Paginator for [`SearchCertificates`](crate::operation::search_certificates::SearchCertificates)
pub struct SearchCertificatesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::search_certificates::builders::SearchCertificatesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl SearchCertificatesPaginator {
    ...
    pub fn items(self) -> crate::operation::search_certificates::paginator::SearchCertificatesPaginatorItems {
        crate::operation::search_certificates::paginator::SearchCertificatesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::search_certificates::SearchCertificates::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_search_certificates_output_output_next_token(resp);
...
/// Flattened paginator for `SearchCertificatesPaginator`
///
/// This is created with [`.items()`](SearchCertificatesPaginator::items)
pub struct SearchCertificatesPaginatorItems(SearchCertificatesPaginator);

impl SearchCertificatesPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_search_certificates_output_output_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
