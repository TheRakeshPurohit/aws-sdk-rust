...
impl CreateAccessPointOutputBuilder {
    ...
    /// - [`access_point_arn`](crate::operation::create_access_point::builders::CreateAccessPointOutputBuilder::access_point_arn)
    /// - [`access_point_id`](crate::operation::create_access_point::builders::CreateAccessPointOutputBuilder::access_point_id)
    /// - [`client_token`](crate::operation::create_access_point::builders::CreateAccessPointOutputBuilder::client_token)
    /// - [`file_system_id`](crate::operation::create_access_point::builders::CreateAccessPointOutputBuilder::file_system_id)
    /// - [`status`](crate::operation::create_access_point::builders::CreateAccessPointOutputBuilder::status)
    /// - [`owner_id`](crate::operation::create_access_point::builders::CreateAccessPointOutputBuilder::owner_id)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_access_point::CreateAccessPointOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_access_point::CreateAccessPointOutput {
            access_point_arn: self.access_point_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "access_point_arn",
                    "access_point_arn was not specified but it is required when building CreateAccessPointOutput",
                )
            })?,
            access_point_id: self.access_point_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "access_point_id",
                    "access_point_id was not specified but it is required when building CreateAccessPointOutput",
                )
            })?,
            client_token: self.client_token.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "client_token",
                    "client_token was not specified but it is required when building CreateAccessPointOutput",
                )
            })?,
            file_system_id: self.file_system_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "file_system_id",
                    "file_system_id was not specified but it is required when building CreateAccessPointOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building CreateAccessPointOutput",
                )
            })?,
            owner_id: self.owner_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "owner_id",
                    "owner_id was not specified but it is required when building CreateAccessPointOutput",
                )
            })?,
