...
impl super::Client {
    ...
    ///   - [`resource_id(impl Into<String>)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::set_resource_id):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the resource to add tags to.</p><br>
    ///   - [`tags(Tag)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::tag_resource::builders::TagResourceFluentBuilder::set_tags):<br>required: **true**<br><p>An array of key-value pairs to add as tags to the resource.</p><br>
