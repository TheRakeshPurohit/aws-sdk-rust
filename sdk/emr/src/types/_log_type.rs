...
impl ::std::convert::From<&str> for LogType {
    fn from(s: &str) -> Self {
        match s {
            "application-logs" => LogType::ApplicationLogs,
            "persistent-ui-logs" => LogType::PersistentUiLogs,
            "system-logs" => LogType::SystemLogs,
...
impl LogType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            LogType::ApplicationLogs => "application-logs",
            LogType::PersistentUiLogs => "persistent-ui-logs",
            LogType::SystemLogs => "system-logs",
            LogType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["application-logs", "persistent-ui-logs", "system-logs"]
    }
}
...
impl ::std::fmt::Display for LogType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            LogType::ApplicationLogs => write!(f, "application-logs"),
            LogType::PersistentUiLogs => write!(f, "persistent-ui-logs"),
            LogType::SystemLogs => write!(f, "system-logs"),
