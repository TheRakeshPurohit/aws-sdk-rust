...
impl ::std::convert::From<&str> for GatewayType {
    fn from(s: &str) -> Self {
        match s {
            "EXTERNAL" => GatewayType::External,
            "INTERNAL" => GatewayType::Internal,
...
impl GatewayType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            GatewayType::External => "EXTERNAL",
            GatewayType::Internal => "INTERNAL",
...
impl ::std::fmt::Display for GatewayType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            GatewayType::External => write!(f, "EXTERNAL"),
            GatewayType::Internal => write!(f, "INTERNAL"),
