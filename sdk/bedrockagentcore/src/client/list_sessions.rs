...
impl super::Client {
    ...
    ///   - [`filter(SessionFilter)`](crate::operation::list_sessions::builders::ListSessionsFluentBuilder::filter) / [`set_filter(Option<SessionFilter>)`](crate::operation::list_sessions::builders::ListSessionsFluentBuilder::set_filter):<br>required: **false**<br><p>Filter criteria to apply when listing sessions.</p><br>
