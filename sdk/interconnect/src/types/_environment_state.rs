...
impl ::std::convert::From<&str> for EnvironmentState {
    fn from(s: &str) -> Self {
        match s {
            "available" => EnvironmentState::Available,
            "limited" => EnvironmentState::Limited,
            "unavailable" => EnvironmentState::Unavailable,
...
impl EnvironmentState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            EnvironmentState::Limited => "limited",
            EnvironmentState::Unavailable => "unavailable",
...
impl ::std::fmt::Display for EnvironmentState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EnvironmentState::Available => write!(f, "available"),
            EnvironmentState::Limited => write!(f, "limited"),
            EnvironmentState::Unavailable => write!(f, "unavailable"),
