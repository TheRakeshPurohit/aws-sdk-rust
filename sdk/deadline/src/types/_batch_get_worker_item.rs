...
impl BatchGetWorkerItem {
    /// Creates a new builder-style object to manufacture [`BatchGetWorkerItem`](crate::types::BatchGetWorkerItem).
    pub fn builder() -> crate::types::builders::BatchGetWorkerItemBuilder {
        crate::types::builders::BatchGetWorkerItemBuilder::default()
    }
}

/// A builder for [`BatchGetWorkerItem`](crate::types::BatchGetWorkerItem).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BatchGetWorkerItemBuilder {
...
impl BatchGetWorkerItemBuilder {
    /// <p>The farm ID of the worker.</p>
    ...
    /// Consumes the builder and constructs a [`BatchGetWorkerItem`](crate::types::BatchGetWorkerItem).
    /// This method will fail if any of the following fields are not set:
    /// - [`farm_id`](crate::types::builders::BatchGetWorkerItemBuilder::farm_id)
    /// - [`fleet_id`](crate::types::builders::BatchGetWorkerItemBuilder::fleet_id)
    /// - [`worker_id`](crate::types::builders::BatchGetWorkerItemBuilder::worker_id)
    /// - [`status`](crate::types::builders::BatchGetWorkerItemBuilder::status)
    /// - [`created_at`](crate::types::builders::BatchGetWorkerItemBuilder::created_at)
    /// - [`created_by`](crate::types::builders::BatchGetWorkerItemBuilder::created_by)
    pub fn build(self) -> ::std::result::Result<crate::types::BatchGetWorkerItem, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::BatchGetWorkerItem {
            farm_id: self.farm_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "farm_id",
                    "farm_id was not specified but it is required when building BatchGetWorkerItem",
                )
            })?,
            fleet_id: self.fleet_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "fleet_id",
                    "fleet_id was not specified but it is required when building BatchGetWorkerItem",
                )
            })?,
            worker_id: self.worker_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "worker_id",
                    "worker_id was not specified but it is required when building BatchGetWorkerItem",
                )
            })?,
            ...
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building BatchGetWorkerItem",
                )
            })?,
            log: self.log,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building BatchGetWorkerItem",
                )
            })?,
            created_by: self.created_by.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_by",
                    "created_by was not specified but it is required when building BatchGetWorkerItem",
                )
            })?,
