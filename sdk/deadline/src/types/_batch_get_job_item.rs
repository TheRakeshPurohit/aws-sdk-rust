...
impl ::std::fmt::Debug for BatchGetJobItem {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("BatchGetJobItem");
...
impl BatchGetJobItem {
    /// Creates a new builder-style object to manufacture [`BatchGetJobItem`](crate::types::BatchGetJobItem).
    pub fn builder() -> crate::types::builders::BatchGetJobItemBuilder {
        crate::types::builders::BatchGetJobItemBuilder::default()
    }
}

/// A builder for [`BatchGetJobItem`](crate::types::BatchGetJobItem).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct BatchGetJobItemBuilder {
...
impl BatchGetJobItemBuilder {
    ...
    /// Consumes the builder and constructs a [`BatchGetJobItem`](crate::types::BatchGetJobItem).
    /// This method will fail if any of the following fields are not set:
    /// - [`farm_id`](crate::types::builders::BatchGetJobItemBuilder::farm_id)
    /// - [`queue_id`](crate::types::builders::BatchGetJobItemBuilder::queue_id)
    /// - [`job_id`](crate::types::builders::BatchGetJobItemBuilder::job_id)
    /// - [`name`](crate::types::builders::BatchGetJobItemBuilder::name)
    /// - [`lifecycle_status`](crate::types::builders::BatchGetJobItemBuilder::lifecycle_status)
    /// - [`lifecycle_status_message`](crate::types::builders::BatchGetJobItemBuilder::lifecycle_status_message)
    /// - [`priority`](crate::types::builders::BatchGetJobItemBuilder::priority)
    /// - [`created_at`](crate::types::builders::BatchGetJobItemBuilder::created_at)
    /// - [`created_by`](crate::types::builders::BatchGetJobItemBuilder::created_by)
    pub fn build(self) -> ::std::result::Result<crate::types::BatchGetJobItem, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::BatchGetJobItem {
            farm_id: self.farm_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "farm_id",
                    "farm_id was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            queue_id: self.queue_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "queue_id",
                    "queue_id was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            job_id: self.job_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "job_id",
                    "job_id was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            lifecycle_status: self.lifecycle_status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "lifecycle_status",
                    "lifecycle_status was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            lifecycle_status_message: self.lifecycle_status_message.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "lifecycle_status_message",
                    "lifecycle_status_message was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            priority: self.priority.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "priority",
                    "priority was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building BatchGetJobItem",
                )
            })?,
            created_by: self.created_by.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_by",
                    "created_by was not specified but it is required when building BatchGetJobItem",
                )
            })?,
...
impl ::std::fmt::Debug for BatchGetJobItemBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("BatchGetJobItemBuilder");
        formatter.field("farm_id", &self.farm_id);
        formatter.field("queue_id", &self.queue_id);
        formatter.field("job_id", &self.job_id);
        formatter.field("name", &self.name);
