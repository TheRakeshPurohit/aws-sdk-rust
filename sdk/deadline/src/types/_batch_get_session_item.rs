...
pub struct BatchGetSessionItem {
...
impl BatchGetSessionItem {
    /// Creates a new builder-style object to manufacture [`BatchGetSessionItem`](crate::types::BatchGetSessionItem).
    pub fn builder() -> crate::types::builders::BatchGetSessionItemBuilder {
        crate::types::builders::BatchGetSessionItemBuilder::default()
    }
}

/// A builder for [`BatchGetSessionItem`](crate::types::BatchGetSessionItem).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct BatchGetSessionItemBuilder {
...
impl BatchGetSessionItemBuilder {
    /// <p>The farm ID of the session.</p>
    ...
    /// Consumes the builder and constructs a [`BatchGetSessionItem`](crate::types::BatchGetSessionItem).
    /// This method will fail if any of the following fields are not set:
    /// - [`farm_id`](crate::types::builders::BatchGetSessionItemBuilder::farm_id)
    /// - [`queue_id`](crate::types::builders::BatchGetSessionItemBuilder::queue_id)
    /// - [`job_id`](crate::types::builders::BatchGetSessionItemBuilder::job_id)
    /// - [`session_id`](crate::types::builders::BatchGetSessionItemBuilder::session_id)
    /// - [`fleet_id`](crate::types::builders::BatchGetSessionItemBuilder::fleet_id)
    /// - [`worker_id`](crate::types::builders::BatchGetSessionItemBuilder::worker_id)
    /// - [`started_at`](crate::types::builders::BatchGetSessionItemBuilder::started_at)
    /// - [`lifecycle_status`](crate::types::builders::BatchGetSessionItemBuilder::lifecycle_status)
    pub fn build(self) -> ::std::result::Result<crate::types::BatchGetSessionItem, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::BatchGetSessionItem {
            farm_id: self.farm_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "farm_id",
                    "farm_id was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
            queue_id: self.queue_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "queue_id",
                    "queue_id was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
            job_id: self.job_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "job_id",
                    "job_id was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
            session_id: self.session_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "session_id",
                    "session_id was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
            fleet_id: self.fleet_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "fleet_id",
                    "fleet_id was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
            worker_id: self.worker_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "worker_id",
                    "worker_id was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
            started_at: self.started_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "started_at",
                    "started_at was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
            lifecycle_status: self.lifecycle_status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "lifecycle_status",
                    "lifecycle_status was not specified but it is required when building BatchGetSessionItem",
                )
            })?,
