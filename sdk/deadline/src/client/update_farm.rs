...
impl super::Client {
    ...
    ///   - [`cost_scale_factor(f32)`](crate::operation::update_farm::builders::UpdateFarmFluentBuilder::cost_scale_factor) / [`set_cost_scale_factor(Option<f32>)`](crate::operation::update_farm::builders::UpdateFarmFluentBuilder::set_cost_scale_factor):<br>required: **false**<br><p>A multiplier applied to the farm's calculated costs for usage data and budget tracking. A value less than 1 represents a discount, a value greater than 1 represents a premium, and a value of 1 represents no adjustment.</p><br>
